  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900">
      ...
      <div className="flex flex-col justify-center px-8">
        <nav className="flex items-center justify-between w-full relative border-gray-200 dark:border-gray-700 mx-auto pt-4 pb-8 sm:pb-16 text-gray-900 dark:text-gray-100">
